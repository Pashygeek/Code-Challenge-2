window.addEventListener('DOMContentLoaded', ()=>{
    ...
    // Displaying a cat gif inside the DOM//
    cuteBtn.addEventListener('click', ()=>{
        ...
        //rendering the image inside the DOM//
        function renderCute(data){
            ...
            // creating a div that houses the button //
            ...
            cute.appendChild(voteSection)
             ...
             // When the voteBtn is pressed it should increase the no. of votes for monkey//
    ...
    zebraBtn.addEventListener('click', ()=>{
        ...
        function renderzebra(data){
            ...
            // vote button being displayed inside the idSections div//
            const voteBtn = document.createElement('button')
            voteBtn.style.width = '85px'
            voteBtn.style.background = 'white'
            voteBtn.style.color = 'blue'
            ...
            // When the voteBtn is pressed it should increase the no. of votes of zebras//
            voteBtn.addEventListener('click', ()=>{
    ...
    lionBtn.addEventListener('click', ()=>{
        ...
        function renderlion(data){
            ...
            // When the voteBtn is pressed it should increase the no. of votes of lions//
            voteBtn.addEventListener('click', ()=>{
    ...
    pandaBtn.addEventListener('click', ()=>{
        ...
        function renderpanda(data){
            ...
            // When the voteBtn is pressed it should increase the no. of votes of panda//
            voteBtn.addEventListener('click', ()=>{
